...
step2_3:"Equipamento de proteção",
...
progress.innerText=String(currentStep).padStart(2,"0")+" / "+String(totalSteps).padStart(2,"0");
}
...
<button class="c4-submit-btn" onclick="respondCopilot()">
${t.copilot_submit}
</button>
...
<button class="c4-option-btn" onclick="stepContact()">
${t.copilot_review}
</button>
