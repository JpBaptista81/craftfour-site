...
discussion_thanks:"Thank you. Our engineering team will review your discussion.",
...
q_impact:"Is the impact scenario related to safety certification or product durability?",
q_auto:"Are you currently validating a component or a full vehicle system?",
q_cad:"Do you already have CAD geometry available for simulation?",
q_thermal:"Is the thermal issue related to electronics cooling or fluid flow?",
q_tools:"What simulation tools are you currently using?",
q_targets:"What performance targets are you trying to achieve?",
q_material:"What material or structure are you analysing?",
...
q_impact:"O cenário de impacto está relacionado com certificação de segurança ou durabilidade do produto?",
q_auto:"Está atualmente a validar um componente ou um sistema completo do veículo?",
q_cad:"Já possui geometria CAD disponível para simulação?",
q_thermal:"O problema térmico está relacionado com arrefecimento de eletrónica ou fluxo de fluido?",
q_tools:"Que ferramentas de simulação está atualmente a utilizar?",
q_targets:"Quais são os objetivos de desempenho que pretende atingir?",
q_material:"Que material ou estrutura está a analisar?",
...
q_impact:"¿El escenario de impacto está relacionado con certificación de seguridad o durabilidad del producto?",
q_auto:"¿Está validando actualmente un componente o un sistema completo del vehículo?",
q_cad:"¿Dispone ya de geometría CAD para realizar la simulación?",
q_thermal:"¿El problema térmico está relacionado con refrigeración de electrónica o flujo de fluidos?",
q_tools:"¿Qué herramientas de simulación está utilizando actualmente?",
q_targets:"¿Qué objetivos de rendimiento intenta alcanzar?",
q_material:"¿Qué material o estructura está analizando?",
...
q_impact:"Le scénario d’impact est-il lié à une certification de sécurité ou à la durabilité du produit ?",
q_auto:"Validez-vous actuellement un composant ou un système complet du véhicule ?",
q_cad:"Disposez-vous déjà d’une géométrie CAO pour la simulation ?",
q_thermal:"Le problème thermique est-il lié au refroidissement électronique ou à l’écoulement des fluides ?",
q_tools:"Quels outils de simulation utilisez-vous actuellement ?",
q_targets:"Quels objectifs de performance cherchez-vous à atteindre ?",
q_material:"Quel matériau ou quelle structure analysez-vous ?",
...
q_impact:"Bezieht sich das Impact-Szenario auf Sicherheitszertifizierung oder Produktlebensdauer?",
q_auto:"Validieren Sie derzeit eine einzelne Komponente oder ein komplettes Fahrzeugsystem?",
q_cad:"Haben Sie bereits CAD-Geometrie für die Simulation verfügbar?",
q_thermal:"Steht das thermische Problem im Zusammenhang mit Elektronikkühlung oder Strömungsanalyse?",
q_tools:"Welche Simulationswerkzeuge verwenden Sie derzeit?",
q_targets:"Welche Leistungsziele möchten Sie erreichen?",
q_material:"Welches Material oder welche Struktur analysieren Sie?",
...
step2_6:"工业系统与工业4.0",
step2_7:"其他工业领域",
q_impact:"冲击场景是否与安全认证或产品耐久性相关？",
q_auto:"您目前是在验证单个部件还是整个车辆系统？",
q_cad:"您是否已经拥有用于仿真的 CAD 几何模型？",
q_thermal:"热问题是否与电子散热或流体流动有关？",
q_tools:"您目前使用哪些仿真软件工具？",
q_targets:"您希望达到哪些性能目标？",
q_material:"您正在分析哪种材料或结构？",
